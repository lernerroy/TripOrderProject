		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Flight Acceptance Screen",
									"targetURL": "#FlightAcceptanceScreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"FlightAcceptanceScreen-display": {
								"semanticObject": "FlightAcceptanceScreen",
								"action": "display",
								"description": "Flight Acceptance Screen",
								"title": "Flight Acceptance Screen",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fas",
									"url": sap.ui.require.toUrl("fas")
								}
							}
						}
					}
