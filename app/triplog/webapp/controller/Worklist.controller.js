sap.ui.define(
  ...
  function (BaseController, JSONModel, formatter, Filter, FilterOperator, ColumnListItem, ObjectIdentifier, ObjectAttribute, ObjectStatus, Rest) {
    "use strict";
      ...
      onSearch: function (oEvent) {
        if (oEvent.getParameters().refreshButtonPressed) {
          ...
          if (sQuery && sQuery.length > 0) {
            aTableSearchState = [
              new Filter("insupcarriercode2", FilterOperator.Contains, sQuery),
            ];
          }
      ...
      onFilter: function () {
        ...
        if (aStatus.length > 0) {
          ...
          aStatus.forEach((vStatus) => {
            aStatusFilter.push(
              new Filter("status_code", FilterOperator.EQ, vStatus)
            );
          });
