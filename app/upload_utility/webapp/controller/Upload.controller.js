  ...
  function (BaseController, JSONModel, formatter, MessageToast) {
    ...
    return BaseController.extend("UpdUtility.uploadutility.controller.Upload", {
      ...
      _uploadRecords: function (records) {
        ...
        var sRecordType = this.getModel("uploadView").getProperty(
          "/uploadTypeIndex"
        );
        var entitySet = "";
        ...
        for (var oRecord of records) {
          ...
          oDataListBinding.create(oRecord, true, false, false);
        }
        ...
        oDataListBinding.attachCreateCompleted(function (oEvent) {
          ...
          if (success) {
            ...
            this.getModel("uploadView").setProperty("/selectedFile", "");
            MessageToast.show("Data has been uploaded!");
          }
        }, this);
      },
