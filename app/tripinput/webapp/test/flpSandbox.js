		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Trip Input Screen",
									"targetURL": "#TripInputScreen-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"TripInputScreen-display": {
								"semanticObject": "TripInputScreen",
								"action": "display",
								"description": "Trip Input Screen",
								"title": "Trip Input Screen",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tripinput",
									"url": sap.ui.require.toUrl("tripinput")
								}
							}
						}
					}
