...
entity TailRegistrations : CodeList, managed {
    key ID                        : UUID @(Core.Computed : true);
        ...
        ac_seat_config            : String(30);
        ac_type_iata              : String(10);
        ac_type_iatag             : String(10);
        ac_type_icao              : String(10);
        mtow_kg                   : Decimal(6,0);
        mtow_t                    : String(6);
        amtow1_kg                 : Decimal(7,0);
        amtow2_kg                 : Decimal(7,0);
        mtw_kg                    : Decimal(6,0);
        amtw_kg                   : Decimal(6,0);
        mlw_kg                    : Decimal(6,0);
        full_cgo_cap              : Decimal(6,0);
        eev_kg                    : String(7);
        wingspan_m                : String(6);
        length_m                  : String(6);
        icao_noise_cat_takeoff    : String(5);
        icao_noise_cat_landing    : String(5);
        icao_chap3_noise_level    : Decimal(5,2);
        icao_chap4_noise_level    : Decimal(5,2);
        icao_annex16_chp          : String(2);
        nri_noise_category        : String(4);
        aci_noise_rate_ind_mtow   : String(5);
        aci_noise_rate_ind_amtow  : String(5);
        engine_app_noise_level    : String(6);
        engine_app_noise_limit    : String(6);
        engine_side_noise_level   : String(6);
        engine_side_noise_limit   : String(6);
        noise_level_start_takeoff : String(6);
        noise_limit_start_takeoff : String(6);
        pax_or_frt                : String(1);
        fcl_seat_cap              : Decimal(2,0);
        jcl_seat_cap              : Decimal(2,0);
        pey_seat_cap              : Decimal(3,0);
        ycl_seat_cap              : Decimal(3,0);
        tot_seat_cap              : Decimal(3,0);
        ac_operator               : String(25);
        body_type                 : String(1);
        number_engines            : Decimal(1,0);
        engine_type               : String(20);
        zero_fuel_weight          : Decimal(6,0);
        euwgtfctr1                : String(5);
        euwgtfctr2                : String(5);
        acoustic_grp              : String(3);
        bulk_ac                   : String(1);
        eev_kg_arn                : String(10);
        ac_total_arn              : String(10);
        lto_fuel                  : Decimal(8,2);
        nox_tp_maint              : Decimal(8,2);
        amtow1_t                  : Decimal(10,0);
        amtow2_t                  : Decimal(10,0);
        engine_takeoff_noise_lvl  : Decimal(7,0);
};
...
type aircraftType : Association to aircraftTypeGroup {
                        aircraftType
                    };
//////////////////////////////////////////////////////////////////////
